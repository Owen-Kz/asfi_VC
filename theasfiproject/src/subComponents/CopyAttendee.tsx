...
export interface CopyAttendeeInfoProps {
  showText?: boolean;
...
const CopyAttendeeInfo = (props: CopyAttendeeInfoProps) => {
  ...
  const copyMeetingInviteButton = 'Copy Invite';
  ...
  if (buttonTemplateName === ButtonTemplateName.bottomBar) {
    ...
    btnTemplateProps.btnText = props.showText ? copyMeetingInviteButton : 'Invite Link';
  }
...
export default CopyAttendeeInfo;
